[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(LikeIt.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(LikeIt.Web.App_Start.NinjectWebCommon), "Stop")]
...
namespace LikeIt.Web.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<DbContext>().To<LikeItDbContext>();
            kernel.Bind<ILikeItDbContext>().To<LikeItDbContext>();
